...
def connect_db(db_name):
    ...
    return sql.connect(host="127.0.0.1", user="root", passwd = "rootpwd", db=db_name)
...
def get_model_top_1(db_name, img_num, model_name):
    """
    Returns the top-1 of the model for selected img
    ...
    Returns:
        top-1 value of the model for that image, 0 or 1
    """
    #print("Connecting to database...")
    connection = connect_db(db_name)
    cursor = connection.cursor()
...
def get_model_top_5(db_name, img_num, model_name):
    """
    Returns the top-5 of the model for selected img
    ...
    Returns:
        top-5 value of the model for that image, 0 or 1
    """
    #print("Connecting to database...")
    connection = connect_db(db_name)
    cursor = connection.cursor()
...
def get_model_top_n(db_name, img_num, model_name, n):
    """
    Returns the top-n of the model for selected img
    ...
    Returns:
        top-n value of the model for that image, 0 or 1
    """
    #print("Connecting to database...")
    connection = connect_db(db_name)
    cursor = connection.cursor()
...
def get_model_time(db_name, img_num, model_name):
    """
    Returns the inference time of the model for selected img
    ...
    Returns:
        inference time of the model for that image
    """
    #print("Connecting to database...")
    connection = connect_db(db_name)
    cursor = connection.cursor()
