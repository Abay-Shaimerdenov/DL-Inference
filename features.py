...
DATA_FILE = 'all_new_features_hier_norm_top_1.csv'
...
def logistic_regression(X_train, X_test, Y_test):
    """
...
# transform the dataset
    ...
    if first_level_machine == 'nn':
        predicted = nearest_neighbour(X_train_first_level, X_val_first_level, Y_train)
        predicted = predicted.tolist()
    elif first_level_machine == 'lg':
        predicted = logistic_regression(X_train_first_level, X_val_first_level, Y_train)
        ...
        predicted = vecto_classifier(X_train_first_level, X_val_first_level, Y_train)
    ...
    if second_level_machine == 'nn':
        predicted = nearest_neighbour(X_train_second_level, X_val_second_level, Y_train_second_level)
    elif second_level_machine == 'lg':
        predicted = logistic_regression(X_train_second_level, X_val_second_level, Y_train_second_level)
        ...
        predicted = vecto_classifier(X_train_second_level, X_val_second_level, Y_train_second_level)
    ...
    if third_level_machine == 'nn':
        predicted = nearest_neighbour(X_train_third_level, X_val_third_level, Y_train_third_level)
    elif third_level_machine == 'lg':
        predicted = logistic_regression(X_train_third_level, X_val_third_level, Y_train_third_level)
        ...
        predicted = vecto_classifier(X_train_third_level, X_val_third_level, Y_train_third_level)
...
def prototype(amount_images, list_premodels):
    ...
    return_wrapper = list()
    preds = CV_fold_worker(test_idx, train_idx, data, first_level_data, second_level_data, third_level_data, first_level_machine, second_level_machine, third_level_machine, return_wrapper)
    return percentage_results, report_results, predicted, correct_result, return_wrapper
